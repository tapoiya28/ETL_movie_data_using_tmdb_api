...
from database.static_repository import StaticRepository
from database.connection import DatabaseConnection

from extractor.company_extractor import CompanyExtractor
from extractor.movie_extractor import MovieExtractor
from extractor.static_extractor import StaticExtractor
...
def main():
    ...
    company_repo = CompanyRepository(db=db, table_name='raw_conpany_data')
